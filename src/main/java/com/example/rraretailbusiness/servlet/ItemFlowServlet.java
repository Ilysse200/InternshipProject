...
public class ItemFlowServlet extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
            ...
            if(itemSales !=null){
                ...
                itemFlow.setItemFlowsalesID(itemSales);
                itemFlow.setItemList(item);

                itemFlowDao.saveItemFlow(itemFlow);
                System.out.println(itemSales.toString());
                ...
                if(itemSales==null){
                    ...
                    itemFlow.setPurchasesItemFlow(purchaseItem);
                    itemFlow.setItemList(item);
                    ...
                    sendErrorMessage(resp, "error saving the itemFlow");
                    return;
                }
